<template>
  <div class="edit-community-wrap">
    <uu-sub-tab
      back
      :menu-array="[{title:'创建社群'}]"></uu-sub-tab>
    <div class="edit-community-form-wrap dashed-border">
      ...
      >
        <el-form-item label="社群名称：" prop="groupName">
          <el-input type="text" :readonly="!editable" placeholder="请输入社群名称" v-model="communityForm.groupName"></el-input>
        </el-form-item>
        ...
        <el-form-item label="搜索范围：" prop="rule">
          <p class="fcg">（要求子社群授予的设备权限     ，可多选）</p>
      ...
      getQrCode(){
        this.$http("/group/code").then(res=>{
          if(res.data){
            ...
            this.$nextTick(()=>{
              const qrCode = new QRCode('community-qrcode',{
                width:74,
                height:74,
                colorDark : "#000000",
